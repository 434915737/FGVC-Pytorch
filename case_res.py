...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        if (adaptive_layer is not None):
            self.adapter1 = adaptive_layer(planes)
        else:
            self.adapter1 = None
        ...
        if (adaptive_layer is not None):
            self.adapter2 = adaptive_layer(planes)
        else:
            self.adapter2 = None
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        if (adaptive_layer is not None):
            self.adapter1 = adaptive_layer(width)
        else:
            self.adapter1 = None
...
class ResNet(nn.Module):
    def __init__(
        ...
        if (adaptive_layer is not None):
            self.adapter_last = adaptive_layer(512 * block.expansion)
        else:
            self.adapter_last = None
...
def resnet18(pretrained: bool = False, progress: bool = True, adaptive_layer: Optional[Callable[..., nn.Module]] = None,
             **kwargs: Any) -> ResNet:
...
def caresnet50(pretrained: bool = False, progress: bool = True, adaptive_layer: Optional[Callable[..., nn.Module]] = None,**kwargs: Any,) -> ResNet:
    ...
    return _resnet("resnet50", Bottleneck, [3, 4, 6, 3], pretrained, progress,adaptive_layer=adaptive_layer, **kwargs)
